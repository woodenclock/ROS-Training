...
static const _SimpleVelocity_type_support_symbol_names_t _SimpleVelocity_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, simple_velocity_msg, msg, SimpleVelocity)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simple_velocity_msg, msg, SimpleVelocity)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, simple_velocity_msg, msg, SimpleVelocity)() {
  return &::simple_velocity_msg::msg::rosidl_typesupport_c::SimpleVelocity_message_type_support_handle;
}
